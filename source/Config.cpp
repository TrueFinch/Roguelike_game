  ...
  for (json::iterator i = json_config.begin(); i != json_config.end(); ++i) {
    if (i.key() == "Actors") {
      ...
      for (json::iterator j = actors_config.begin(); j != actors_config.end(); ++j) {
        if (j.key() == "Hero") {
          json hero_config = *j;
          hero_stat_ = stats::HeroStat(hero_config["health_points_"].get<int>(),
                                       hero_config["health_points_"].get<int>(),
                                       hero_config["mana_points_"].get<int>(),
                                       hero_config["mana_points_"].get<int>(),
                                       hero_config["damage_points_"].get<int>(),
                                       hero_config["damage_points_"].get<int>(),
                                       hero_config["visibility_points_"].get<int>(),
                                       hero_config["visibility_points_"].get<int>(),
                                       hero_config["dead_symbol_code_"].get<char>(),
                                       hero_config["undead_symbol_code_"].get<char>(),
        ...
        if (j.key() == "Zombie") {
          ...
          zombie_stat_ = stats::ZombieStat(zombie_config["health_points_"].get<int>(),
                                           zombie_config["health_points_"].get<int>(),
                                           zombie_config["damage_points_"].get<int>(),
                                           zombie_config["damage_points_"].get<int>(),
                                           zombie_config["visibility_points_"].get<int>(),
                                           zombie_config["visibility_points_"].get<int>(),
                                           zombie_config["dead_symbol_code_"].get<char>(),
                                           zombie_config["undead_symbol_code_"].get<char>(),
        ...
        if (j.key() == "Wall") {
          json wall_config = *j;
          wall_stat_ = stats::WallStat(wall_config["health_points_"].get<int>(),
                                       wall_config["health_points_"].get<int>(),
                                       wall_config["dead_symbol_code_"].get<char>(),
                                       wall_config["undead_symbol_code_"].get<char>(),
        ...
        if (j.key() == "Princess") {
          ...
          princess_stat_ = stats::PrincessStat(princess_config["mana_points_"].get<int>(),
                                               princess_config["mana_points_"].get<int>(),
                                               princess_config["visibility_points_"].get<int>(),
                                               princess_config["visibility_points_"].get<int>(),
                                               princess_config["dead_symbol_code_"].get<char>(),
                                               princess_config["undead_symbol_code_"].get<char>(),
        ...
        if (j.key() == "Dragon") {
          ...
          dragon_stat_ = stats::DragonStat(dragon_config["health_points_"].get<int>(),
                                           dragon_config["health_points_"].get<int>(),
                                           dragon_config["mana_points_"].get<int>(),
                                           dragon_config["mana_points_"].get<int>(),
                                           dragon_config["damage_points_"].get<int>(),
                                           dragon_config["damage_points_"].get<int>(),
                                           dragon_config["visibility_points_"].get<int>(),
                                           dragon_config["visibility_points_"].get<int>(),
                                           dragon_config["dead_symbol_code_"].get<char>(),
                                           dragon_config["undead_symbol_code_"].get<char>(),
